...
BEGIN
  ...
  -- Own the leave_requests write inside this transaction so the ledger
  -- and the leave row cannot diverge on RPC failure.
  ...
  IF v_ledger.id IS NULL THEN
    -- No linked credit — the leave row is still settled above.
