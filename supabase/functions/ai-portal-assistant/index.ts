...
const DATA_TOOLS = [
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: {
          search: { type: "string", description: "Search term (customer name, order number, product)" },
          status: { type: "string", description: "Filter by status: pending, confirmed, dispatched, delivered, cancelled" },
          payment_status: { type: "string", description: "Filter by payment: pending, partial, paid" },
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: {
          search: { type: "string", description: "Search term (customer name, company, product)" },
          status: { type: "string", description: "Filter by status: new, responded, converted, closed" },
          lead_temperature: { type: "string", description: "Filter: hot, warm, cold" },
          limit: { type: "number", description: "Max results (default 20)" },
        },
        required: [],
      },
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          status: { type: "string", description: "Filter: active, won, lost, stalled" },
          limit: { type: "number", description: "Max results (default 20)" },
        },
        required: [],
      },
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: {
          search: { type: "string", description: "Product name or category" },
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: {
          search: { type: "string", description: "Employee name or department" },
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: {
          search: { type: "string", description: "Task title or description" },
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: {
          search: { type: "string", description: "Ticket title or number" },
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: {
          search: { type: "string", description: "Product name, supplier, or procurement number" },
          payment_status: { type: "string", description: "Filter: pending, partial, paid" },
          limit: { type: "number", description: "Max results (default 20)" },
        },
        required: [],
      },
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: {
          search: { type: "string", description: "Supplier name or category" },
          limit: { type: "number", description: "Max results (default 20)" },
        },
        required: [],
      },
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: {
          search: { type: "string", description: "Expense description or category" },
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: {
          search: { type: "string", description: "Customer name, drone model, or repair number" },
          status: { type: "string", description: "Filter: received, diagnosing, repairing, completed, delivered" },
          limit: { type: "number", description: "Max results (default 20)" },
        },
        required: [],
      },
