...
// Portal B2B customer invite. Copy, CTA and subject match the legacy
// Resend HTML in portal-invite-customer/index.ts (renderInviteEmail).
...
const Email = (p: Props = {}) => {
  ...
  const link = p.action_link || 'https://xboomflow.com/portal/activate'
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={card}>
            ...
            <Text style={fine}>This link will expire in 24 hours. If you weren't expecting this invitation, you can ignore this email.</Text>
          </Section>
...
export const template = {
  ...
  displayName: 'Portal — B2B Customer Invite',
  transactional: true,
  previewData: {
    full_name: 'Jane Doe',
    action_link: 'https://xboomflow.com/portal/activate?invite=demo',
