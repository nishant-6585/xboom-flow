...
NEXT: Turn D in flight (send-ticket-email + portal-notify templates). Then D–G per plan; before G: seam multi-recipient fix. Post-G: KYC card delivery-status fix, kyc-handler dead constant.
