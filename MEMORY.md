...
- **Confirmation sends — remaining:** ⏳ DLT template `OrderConfirmationRequest` (static URL, XBOOMT header) awaiting approval → then create MSG91 flow with same text + DLT id → hand flow ID to Lovable for the `confirmation_request` SMS.
