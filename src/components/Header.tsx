...
import { LogOut, Shield, Package, Building2, Menu, Home, ShoppingCart, Warehouse, FileSpreadsheet, Zap, IndianRupee, ListTodo, Users, CalendarDays, Receipt, ClipboardList } from "lucide-react";
...
export function Header() {
  ...
  // Secondary navigation items (Tasks, HR, Expenses, Forms)
