...
const DEFAULT_ROWS: RowData[] = [
  { key: '1', sl_no: 1, description: 'Emails', sub_items: '', time_from: '10:00', time_to: '10:30', duration_mins: 30, target_value: 0, is_break: false },
  { key: '2', sl_no: 2, description: 'Meetings', sub_items: '', time_from: '10:30', time_to: '11:00', duration_mins: 30, target_value: 0, is_break: false },
  { key: '3', sl_no: 3, description: 'Follow-ups', sub_items: 'Mails,Messages', time_from: '11:00', time_to: '11:30', duration_mins: 30, target_value: 0, is_break: false },
  { key: '4', sl_no: 4, description: 'Analysis', sub_items: '', time_from: '11:30', time_to: '12:30', duration_mins: 60, target_value: 0, is_break: false },
  ...
  { key: '7', sl_no: 7, description: 'Outbound - Lead Generation', sub_items: '', time_from: '14:00', time_to: '14:30', duration_mins: 30, target_value: 0, is_break: false },
  { key: '8', sl_no: 8, description: 'Outbound - Emails', sub_items: '', time_from: '14:30', time_to: '15:00', duration_mins: 30, target_value: 0, is_break: false },
  { key: '9', sl_no: 9, description: 'Emails + Calls', sub_items: '', time_from: '16:00', time_to: '16:30', duration_mins: 60, target_value: 0, is_break: false },
  { key: '10', sl_no: 10, description: 'Follow Ups & Meetings', sub_items: '', time_from: '16:30', time_to: '17:00', duration_mins: 15, target_value: 0, is_break: false },
  { key: '11', sl_no: 11, description: 'Break', sub_items: '', time_from: '17:00', time_to: '17:15', duration_mins: 15, target_value: 0, is_break: true },
  { key: '12', sl_no: 12, description: 'CRM + Tools', sub_items: '', time_from: '17:15', time_to: '18:00', duration_mins: 45, target_value: 0, is_break: false },
            ...
            <tbody>
              {rows.map((row, i) => (
                <tr key={row.key} className={`border-b ${row.is_break ? 'bg-green-500/10' : ''}`}>
                  ...
                  <td className="p-1">
                    <Input type="number" value={row.target_value} onChange={e => updateRow(i, 'target_value', Number(e.target.value))} className="h-8 text-sm text-center" />
                  </td>
                  <td className="p-1 text-center">
