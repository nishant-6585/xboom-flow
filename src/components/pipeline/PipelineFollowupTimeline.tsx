...
export function PipelineFollowupTimeline({ pipelineId, onLogFollowup }: Props) {
  const { followups, loading } = usePipelineFollowupTimeline(pipelineId);
